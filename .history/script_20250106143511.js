...
document.addEventListener('DOMContentLoaded', function () {
    ...
    // Handle date selection and price calculation
    ...
    function calculateTotal() {
        ...
        if (!selectedRoomId || !checkInDate || !checkOutDate) return;
        ...
        // Update total price field (if you have one)
        document.getElementById('total_price').textContent = `Total Price: ${totalPrice} KES`;
    }
});
