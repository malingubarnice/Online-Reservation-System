...
<body>
    <div class="container">
        <h2 class="title">Reservations Report</h2>
        ...
        ?>
            <h3 class="group-title"><?php echo $formattedDate; ?> - Total Reservations: <?php echo $totalBookings; ?></h3>
        ...
        <!-- CSV Export -->
        <form class="export-form" action="export_reservations.php" method="POST">
