...
// Log the received data to check if contact_info is included
error_log("Received data: " . print_r($data, true));  // Log the whole incoming data array

// Log specific contact_info to ensure it's received correctly
error_log("Received contact_info: " . $data['contact_info']);  // This should log the contact_info value
