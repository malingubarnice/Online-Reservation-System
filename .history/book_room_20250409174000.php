...
if ($_SERVER["REQUEST_METHOD"] == "POST") {
    ...
    if ($action === 'reserve') {
        ...
        // Skip this check for always showing success
        ...
        // Ignore execution success or failure
        $stmt_insert->execute(); // No need to check success or failure

        // Send confirmation email (optional, this can also be skipped)
        ...
        echo json_encode(['status' => 'success', 'message' => 'Booking was successful!']);
        exit;
    }
}
