...
if ($_SERVER["REQUEST_METHOD"] == "POST") {
    ...
    if ($action === 'reserve') {
        ...
        if ($date < $currentDate) {
            ...
            exit; // Stop script execution immediately (NO EMAIL SENT)
        }
        ...
        if ($stmt_insert->execute()) {
            // ✅ Only send email after a successful reservation (No past dates will reach here)
            require 'send.php'; // Include the email-sending logic
            ...
            // Send the email
            send_email($_POST); // ✅ Use a function from send.php instead of including the file again
