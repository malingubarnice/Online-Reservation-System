...
if ($_SERVER["REQUEST_METHOD"] == "POST") {
    ...
    if ($action === 'reserve') {
        ...
        if ($stmt_insert->execute()) {
            // ✅ Call send_email.php only after successful reservation
            $postData = [
                'contact-info' => $contact_info,
                'customer-name' => 'Valued Customer', // You can update this if you store customer names
                'date' => $date,
                'time' => $time,
            ...
            // Send email request using cURL
            $ch = curl_init();
            curl_setopt($ch, CURLOPT_URL, 'https://yourwebsite.com/send_email.php'); // Replace with actual URL
        ...
        exit; // Stop execution after successful reservation
