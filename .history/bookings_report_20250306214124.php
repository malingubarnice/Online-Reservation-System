...
// Search filter for Booking ID (now allowing alphanumeric input)
...
if (!empty($search)) {
    ...
    $query .= " WHERE booking_id LIKE '%$search%'";  // Allows partial search (e.g., "BKG-89" matches "BKG-89543")
}
...
<!-- Search Form (Now Accepting Booking ID Format "BKG-XXXXX") -->
<form method="GET">
