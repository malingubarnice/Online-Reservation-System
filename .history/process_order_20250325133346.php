...
if ($_SERVER["REQUEST_METHOD"] == "POST") {
    ...
    try {
        ...
        $totalAmount = htmlspecialchars($_POST["amount"] ?? "0");
        $deliveryCost = htmlspecialchars($_POST["delivery_cost"] ?? "0");

        // Get ordered items (Ensure it is properly passed as JSON in the request)
        $orderDetails = "";
